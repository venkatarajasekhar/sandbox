...
def run(grid, goal, spath, params, printflag = False, speed = 0.1, timeout = 1000):
    ...
    while not myrobot.check_goal(goal) and N < timeout:
        ...
        # ----------------------------------------
        # compute the CTE CROSS CHECK ERROR
...
# Note if you apply twiddle on those parameters, 
# make sure that you have a timeout in your function to that you return from 
