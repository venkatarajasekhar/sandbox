...
int main()
{
   ...
   cout << "\n\nCalling virtual function print with base-class pointer"
      ...
      << "print function:\n\n";
   commissionEmployeePtr->print();                                                  // invokes base-class print thru dynamic binding
   ...
   cout << "\n\nCalling virtual function print with derived-class "
      ...
      << "print function:\n\n";
   basePlusCommissionEmployeePtr->print();                                          // invokes derived-class print thru dynamic binding
   ...
   commissionEmployeePtr->print();                                                  // polymorphismi thru dynamic binding
   cout << endl;
} 
