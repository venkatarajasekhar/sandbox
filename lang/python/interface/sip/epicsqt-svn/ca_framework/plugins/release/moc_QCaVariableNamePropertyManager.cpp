...
const QMetaObject QCaVariableNamePropertyManager::staticMetaObject = {
    { &QTimer::staticMetaObject, qt_meta_stringdata_QCaVariableNamePropertyManager,
      qt_meta_data_QCaVariableNamePropertyManager, 0 }
};
...
int QCaVariableNamePropertyManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: newVariableNameProperty((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< uint(*)>(_a[3]))); break;
        case 1: subscribeDelayExpired(); break;
        default: ;
        }
        _id -= 2;
    }
