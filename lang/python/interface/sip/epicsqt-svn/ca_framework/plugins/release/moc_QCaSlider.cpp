...
**
** Created: Wed Apr 6 09:21:03 2011
...
int QCaSlider::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dbValueChanged((*reinterpret_cast< const qlonglong(*)>(_a[1]))); break;
        case 1: connectionChanged((*reinterpret_cast< QCaConnectionInfo(*)>(_a[1]))); break;
        case 2: setValueIfNoFocus((*reinterpret_cast< const long(*)>(_a[1])),(*reinterpret_cast< QCaAlarmInfo(*)>(_a[2])),(*reinterpret_cast< QCaDateTime(*)>(_a[3])),(*reinterpret_cast< const uint(*)>(_a[4]))); break;
        case 3: userValueChanged((*reinterpret_cast< const int(*)>(_a[1]))); break;
