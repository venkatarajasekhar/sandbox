...
**
** Created: Wed Apr 6 09:20:59 2011
...
const QMetaObject qcaobject::QCaObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qcaobject__QCaObject,
      qt_meta_data_qcaobject__QCaObject, 0 }
};
...
int qcaobject::QCaObject::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dataChanged((*reinterpret_cast< const QVariant(*)>(_a[1])),(*reinterpret_cast< QCaAlarmInfo(*)>(_a[2])),(*reinterpret_cast< QCaDateTime(*)>(_a[3]))); break;
        case 1: connectionChanged((*reinterpret_cast< QCaConnectionInfo(*)>(_a[1]))); break;
        case 2: { bool _r = writeData((*reinterpret_cast< const QVariant(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 3: resendLastData(); break;
        case 4: setChannelExpired(); break;
        default: ;
        }
        _id -= 5;
    }
