...
**
** Created: Wed Apr 6 09:21:06 2011
...
int QCaLineEdit::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: setTextIfNoFocus((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< QCaAlarmInfo(*)>(_a[2])),(*reinterpret_cast< QCaDateTime(*)>(_a[3])),(*reinterpret_cast< const uint(*)>(_a[4]))); break;
        case 3: userReturnPressed(); break;
        case 4: userEditingFinished(); break;
        case 5: requestEnabled((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 6;
    }
